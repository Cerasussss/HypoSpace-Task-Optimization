...
def main():
    ...
    parser.add_argument("--n-observations", type=int, default=None,
                        help="Number of observations (default: number of nodes). Without --fixed, generates 1 to n observations")
    parser.add_argument("--fixed", action="store_true",
                        help="With --n-observations, generate only that exact count (not 1 through n)")
    parser.add_argument("--max-edges", type=int, default=None, help="Maximum edges in DAGs (default: no limit)")
    parser.add_argument("--n-samples", type=int, default=None,
                        help="Sample this many observation combinations before checking compatibility (much faster for large node counts)")
