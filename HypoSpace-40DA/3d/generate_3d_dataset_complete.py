...
def main():
    ...
    if args.fixed:
        print(
            f"Generating all top views for {args.grid_size}x{args.grid_size} grid with EXACTLY {args.max_blocks} blocks...")
    else:
        print(
            f"Generating all top views for {args.grid_size}x{args.grid_size} grid with 1 to {args.max_blocks} blocks...")
